...
def evaluate(
    ...
    **kwargs,
    ...
    checkpoint_path = Path("/home/classlab2/root/OrienterNet/experiments/OrienterNet_depth_0623/last.ckpt")
    ...
    dataset.setup()
    # output_dir = Path("/home/classlab2/root/OrienterNet/test/boreas_rain_vision")
