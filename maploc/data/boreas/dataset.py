...
import cv2
# from maploc.radar2UTM import extract_local_coordinates,points_local_to_utm
class BoreasDataModule(pl.LightningDataModule):
    ...
    def get_frame_data(self, date, drive, index):
        ...
        roll_pitch_yaw = np.array([-roll, -pitch, yaw_gps], np.float32)  # for some reason +90
        return {
